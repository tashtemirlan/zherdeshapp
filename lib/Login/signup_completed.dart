...
class SignUpCompletedPage extends StatefulWidget{
  const SignUpCompletedPage({super.key});

  @override
  SignUpPageCompletedState createState ()=> SignUpPageCompletedState();
}
class SignUpPageCompletedState extends State<SignUpCompletedPage>{
  ...
  void setDataRussian(){
    createSuccess="Вы успешно создали аккаунт!\nВперед! Окунитесь в мир Жердеш!";
